...
![npm](https://img.shields.io/npm/v/@appweaver/create-weaver-app)
![NPM License](https://img.shields.io/npm/l/@appweaver/create-weaver-app)
![npm](https://img.shields.io/npm/dw/@appweaver/create-weaver-app)
