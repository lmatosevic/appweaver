 ...
 * @return {string[]} An array of strings obtained by splitting the input string, or the default array if the input is null or undefined.
 */
 ...
 * @param {string} pool - A string representing the set of characters to use for the random string. Defaults to "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".
 ...
 * @return {string} A URL-friendly slug generated by concatenating the input strings, normalizing, and removing unwanted characters.
 */
 ...
 * @param {string} [divider='_'] - The divider used to separate words in the resulting snake_case string. Defaults to an underscore ('_').
 ...
 * @param {Record<string, any>} [extraVariables={}] An object containing additional variables to be used for replacement. The keys represent variable names, and the values are the replacement values.
