...
const configSchema = Type.Object({
  ...
  SECURITY_GOOGLE_ENABLED: Type.Boolean({ default: false }),
  SECURITY_GOOGLE_CLIENT_ID: Type.Optional(Type.String()),
  SECURITY_GOOGLE_CLIENT_SECRET: Type.Optional(Type.String()),
  SECURITY_FACEBOOK_ENABLED: Type.Boolean({ default: false }),
  SECURITY_FACEBOOK_CLIENT_ID: Type.Optional(Type.String()),
  SECURITY_FACEBOOK_CLIENT_SECRET: Type.Optional(Type.String()),
